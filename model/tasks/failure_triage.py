...
from utils.public_function import SLD, aggregate_failure_representations
...
def FT(model, test_samples, cases, type_hash, type_dict, split_ratio=0.7, method='num', t_value=3, before=60, after=300, max_clusters=15, channel_dict=None, verbose=False):
    failure_representations, type_labels = aggregate_failure_representations(cases, SLD(model, test_samples, t_value), type_hash, before, after)
    ...
    precision, recall, f1 = eval_FT(test_labels, test_pre)
